...
# Build the Rust project for a specific target (static build) for macOS.
build-macos-static-%:
	RUSTFLAGS='-C link-args=-static-libgcc' OPENSSL_STATIC=1 cross build --bin anvil-zksync --target $* --release
